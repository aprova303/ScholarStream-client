      ...
      <div className="hero-content text-center text-neutral-content">
        <div className="max-w-2xl">
          <h1 className="mb-5 text-5xl font-bold text-white">
            Unlock Your Future with <span className="bg-gradient-to-r from-[#654ea3] to-[#eaafc8] text-transparent bg-clip-text">
  ScholarStream
</span>
          ...
          <Link to="/scholarships" className="btn bg-gradient-to-r from-[#654ea3] to-[#eaafc8] border-none btn-lg">
            Search Scholarships
          </Link>
        </div>
      </div>
