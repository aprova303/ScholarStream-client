...
const ModeratorReviews = () => {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-3xl md:text-4xl font-bold text-gray-800">All Reviews</h1>
        <p className="text-gray-500 mt-2">Moderate student reviews and feedback</p>
      </div>
            ...
            <div key={r._id || r.id} className="card bg-base-100 shadow-xl">
              <div className="card-body">
                <div className="flex justify-between items-start mb-3">
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-500">
                      Reviewed by: <strong>{r.reviewerName || 'Anonymous'}</strong> • 
                ...
                <div className="flex justify-between items-center text-xs text-gray-500">
                  ...
                  <span className="badge">Review ID: {(r._id || r.id).toString().slice(0, 8)}</span>
                </div>
              </div>
            </div>
          ))}
